...
const workers = {
  ...
  office: { files: ['office.worker.ts', 'office-operations.ts'], evidence: ['executeOfficeOperation', 'spreadsheet-convert', 'docx-to-pdf'] },
  'pdf-read': { files: ['pdf-read.worker.ts', 'pdf-operations.ts'], evidence: ['executePdfOperation', 'getDocument', 'pdf-to-images'] },
