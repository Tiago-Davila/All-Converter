...
- [X] T037 [US5] Implementar MP3→MP4 con portada/waveform y fixture en `src/converters/mp3-to-mp4.ts`, `src/workers/media.worker.ts` y `tests/converters/mp3-to-mp4.test.ts` (depende de T035).
- [X] T038 [P] [US5] Implementar conversiones MP3↔WAV/OGG/M4A y fixture en `src/converters/audio.ts`, `src/workers/media.worker.ts` y `tests/converters/audio.test.ts` (depende de T035).
